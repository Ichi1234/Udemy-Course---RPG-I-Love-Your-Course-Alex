...
public class UI_TreeConnectHandler : MonoBehaviour
{
    ...
    public void SetPosition(Vector2 postition) => rect.anchoredPosition = postition;
    private void OnValidate()
    {
        ...
        {
            Debug.Log("Amount of details should be the same amount of connection. - " + gameObject.name);
            return;
        }
