...
public class Skill_SwordThrow : Skill_Base
{
    ...
    [Range(0, 10)]
    [SerializeField] private float regularThrowPower = 2.8f;

    [Header("Pierce Sword Upgrade")]
    [SerializeField] private GameObject pierceSwordPrefab;
    public int amountToPierce = 2;
    [SerializeField] private float pierceThrowPower = 2.8f;

    [Header("Spin Sword Upgrade")]
    [SerializeField] private GameObject spinSwordPrefab;
    [SerializeField] public int maxDistance = 5;
    [SerializeField] public float attackPerSecond = 6;
    [SerializeField] public int maxSpinDuration = 2;
    [Range(0, 10)]
    [SerializeField] private float spinThrowPower = 2.8f;
    ...
    [Range(0, 10)]
    [SerializeField] private float bounceThrowPower = 2.8f;
    ...
    public void PredictTrajectory(Vector2 direction)
    {
        ...
        {
            dots[i].position = GetTrajectory(direction, i * spaceBetweenDots);
        }
    }
